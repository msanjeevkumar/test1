...
namespace test.iOS
{
	...
	public partial class AppDelegate : global::Xamarin.Forms.Platform.iOS.FormsApplicationDelegate
	{
		...
		{
			var logger = (test.Common.Logging.ILogger)ContainerManager.Container.Resolve(typeof(test.Common.Logging.ILogger), typeof(test.Common.Logging.ILogger).GetType().ToString());
